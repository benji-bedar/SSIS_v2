...
course_code = tk.Label(course_detail_frame,text="Course Code:", font=("Times", 12), bg="white", foreground="red")
...
courname_label = tk.Label(course_detail_frame,text="Course:", font=("Times", 14), bg="white", foreground="red")
...
id_label = tk.Label(detail_frame,text="ID No.:", font=("Times", 14), bg="white", foreground="red")
...
NAME = StringVar()
name_label = tk.Label(detail_frame,text="Name:", font=("Times", 14), bg="white", foreground="red")
...
GENDER = StringVar()
gender_label = tk.Label(detail_frame,text="Gender:", font=("Times", 14), bg="white", foreground="red")
...
AGE = StringVar()
age_label = tk.Label(detail_frame,text="Age:", font=("Times", 14), bg="white", foreground="red")
...
COURSE = StringVar()
course_label = tk.Label(detail_frame,text="Course Code:", font=("Times", 13), bg="white", foreground="red")
...
YEAR = StringVar()
yrlvl_label = tk.Label(detail_frame,text="Year Level:", font=("Times", 14), bg="white", foreground="red")
...
EMAIL = StringVar()
email_label = tk.Label(detail_frame,text="Email:", font=("Times", 14), bg="white", foreground="red")
...
id1_entry = tk.Entry(subdata_frame, bd=1,font=("Times", 14), bg="white", foreground="green")
id1_entry.place(x=230, y=60, width=300, height=28)
name1_entry = tk.Entry(subdata_frame, bd=1,font=("Times", 14), bg="white", foreground="green")
...
age1_entry = tk.Entry(subdata_frame, bd=1,font=("Times", 14), bg="white", foreground="green")
age1_entry.place(x=230, y=210, width=300, height=28)
courcode_entry = tk.Entry(subdata_frame, bd=1,font=("Times", 14), bg="white", foreground="green")
courcode_entry.place(x=230, y=260, width=300, height=28)
course1_entry = tk.Entry(subdata_frame, bd=1,font=("Times", 12), bg="white", foreground="green")
...
email1_entry = tk.Entry(subdata_frame, bd=1,font=("Times", 14), bg="white", foreground="green")
...
button_frame = tk.Frame(detail_frame, bg="red",bd=0, relief= tk.GROOVE)    
...
course_btn = tk.Button(detail_frame,bg="white",foreground="red",text="COURSES",bd=2,font=("Times", 15), width=20, command=Student.mngCourse)
course_btn.place(x= 100, y= 500)

# Buttons for Course Detail Frame

course_button_frame = tk.Frame(course_detail_frame, bg="red",bd=0, relief= tk.GROOVE)    
...
student_btn = tk.Button(course_detail_frame,bg="white",foreground="red",text="STUDENTS",bd=2,font=("Times", 15), width=20, command=Student.mngStudent)
...
search_btn = tk.Button(root, bg="black",foreground="red", text=" SEARCH STUDENT ", compound="right", image=search_logo, relief=tk.RAISED, bd=2,font=("Times", 12), width=15, command=Student.search)
